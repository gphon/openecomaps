...
PAGE_FISH_P_IMAGE = 'img/flyer/potsdam_fisch.png'
PAGE_FISH_P_FLYER = 'bin/stuttgart_fisch.pdf'

PAGE_FISH_S_TITLE = 'Fischliste Stuttgart'
PAGE_FISH_S_TEXT =  'Seit mehreren Jahrzehnten werden die Weltmeere industriell ausgebeutet. Das hat dazu gefÃ¼hrt, dass 87 Prozent der FischbestÃ¤nde zu den Ãœberfischten oder erschÃ¶pften BestÃ¤nden gezÃ¤hlt werden. Die maritimen Ökosysteme sind außerdem noch von anderen, menschengemachten Gefahren bedroht: Vermüllung der Meere mit PlastikabfÃƒÂƒÃ‚Â¤llen, Verschmutzung mit ÃƒÂƒÃ‚Â–l durch zunehmende Tiefseebohrungen, ÃƒÂƒÃ‚ÂœberdÃƒÂƒÃ‚Â¼ngung der Meere durch industrielle Landwirtschaft, Klimawandel. Die Organisation Greenpeace kÃƒÂƒÃ‚Â¤mpft seit ihrer GrÃƒÂƒÃ‚Â¼ndung fÃƒÂƒÃ‚Â¼r den Erhalt der MeeresÃƒÂƒÃ‚Â¶kosysteme. Greenpeace Stuttgart setzt die Themen lokal und verbrauchernah um. So ist unsere Stuttgarter Fischliste bereits in der neunten Auflage.'
PAGE_FISH_S_IMAGE = 'img/flyer/stuttgart_fisch.png'
PAGE_FISH_S_FLYER = 'bin/stuttgart_fisch.pdf'

PAGE_PAPER_B_TITLE = 'Papierratgeber Berlin'
PAGE_PAPER_B_TEXT = '2008 haben wir einen Papierratgeber für Berlin entwickelt, der jedes Jahr aktualisiert wird und auf diesen Internetseiten zum Download bereit steht. Besonders möchten wir auch die Verwendung von Recyclingpapier in der Schule fördern, dafür sind wir auf Schul- und Kinderfesten oft präsent.'
PAGE_PAPER_B_IMAGE = 'img/flyer/berlin_papier.jpg'
PAGE_PAPER_B_FLYER = 'bin/berlin_papier.pdf'
...
PAGE_PAPER_Halle_IMAGE = 'img/flyer/halle_papier.jpg'
PAGE_PAPER_Halle_FLYER = 'bin/halle_papier.pdf'

PAGE_PAPER_HH_TITLE = 'Papierratgeber Hamburg'
PAGE_PAPER_HH_TEXT = 'keine Beschreibung hinterlegt'
PAGE_PAPER_HH_IMAGE = 'img/flyer/hamburg_papier.png'
PAGE_PAPER_HH_FLYER = 'bin/hamburg_papier.pdf'

PAGE_PAPER_P_TITLE = 'Papierratgeber Potsdam'
PAGE_PAPER_P_TEXT = '2008 haben wir einen Papierratgeber für Potsdam entwickelt, der jedes Jahr aktualisiert wird und auf diesen Internetseiten zum Download bereit steht. Besonders mÃƒÂ¶chten wir auch die Verwendung von Recyclingpapier in der Schule fÃƒÂ¶rdern, dafÃƒÂ¼r sind wir auf Schul- und Kinderfesten oft prÃƒÂ¤sent.'
PAGE_PAPER_P_IMAGE = 'img/flyer/berlin_papier.jpg'
PAGE_PAPER_P_FLYER = 'bin/berlin_papier.pdf'

###############################################################################

SEAL_EU_BIO_NAME = 'EU-Bio'
SEAL_EU_BIO_DESCRIPTION = '''
...
'''
SEAL_EU_BIO_IMAGE = 'img/seals/eu_bio.svg'

SEAL_DEMETER_NAME = 'Demeter'
SEAL_DEMETER_DESCRIPTION = '''
